...
namespace libraryAPI.Test
{
    public class BooksControllerTest
    {
        ...
        [Theory]
        [InlineData("Islom", "Test Driven Development", "Basics of TDD in dotnet framework 2022.")]
        public void CreateBookTest(string author, string title, string description)
        {
            var book = new Book()
            {
                Author = author,
            ...
            //Act
            _controller.ModelState.AddModelError("Title", "Title is a requried filed");
            var badResponse = _controller.Create(incompleteBook);
